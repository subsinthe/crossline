...
class FilesystemStreamingService(scope: CoroutineScope) : IStreamingService {
    override val searchEngine = SearchEngine(scope)

    class SearchEngine(private val scope: CoroutineScope) : IMusicSearchEngine {
        ...
        private companion object {
            val LOG = loggerFor<FilesystemStreamingService.SearchEngine>()
        }
    }
